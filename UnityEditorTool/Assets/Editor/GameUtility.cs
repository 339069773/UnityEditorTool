...
public class GameUtility
{
    ...
    public static string[] GetSpecifyFilesInFolderTopOnly(string path, string[] extensions = null, bool exclude = false)
    {
        if (string.IsNullOrEmpty(path))
        {
            return null;
    ...
    public static bool SaveDownloadedFile(string fileName, string cachePath)
    {
        var filePath = AssetBundleUtility.GetPersistentDataPath(fileName);
        return GameUtility.SafeRenameFile(FormatToSysFilePath(cachePath), filePath);
    }
